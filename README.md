...
# Catalogue xml to xlsx GUI
This maven project module, written in Java, can be used for converting EFSA's catalogues from xml to xlsx using a graphical user interface.
